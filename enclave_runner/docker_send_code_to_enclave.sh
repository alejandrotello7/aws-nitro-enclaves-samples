...
curl -X POST -F "file=@/usr/src/app/enclave_runner/tester_enclave_runner" https://ec2-3-77-41-49.eu-central-1.compute.amazonaws.com:5000/api/execute_interceptor
